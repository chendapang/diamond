...
<script type="text/html" id="tpl">
			...
			<tr>
				...
				<td>
					<a href="https://mp.weixin.qq.com/cgi-bin/showqrcode?ticket={{ item.ticket }}" target="_blank" class="layui-btn layui-btn-normal layui-btn-mini">查看</a>
...
var url_getList = '/sceneQrcode/getList';
var url_getEditPage = '/page/wxmanage/qrcode_edit';
var url_doGet= "/sceneQrcode/doGet";
var url_doDelete= "/sceneQrcode/doDelete";
var url_doEdit= "/sceneQrcode/doEdit";
