...
<script type="text/html" id="tpl">
			...
			<tr>
				...
				<td>{{ item.title }}</td>
				<td><img src="{{ item.thumb }}" width="50" height="50"></td>
...
var url_getList = '/activity/getList';
var url_getEditPage = '/page/activity/activity_edit';
var url_doGet= "/activity/doGet";
var url_doDelete= "/activity/doDelete";
var url_doEdit= "/activity/doEdit";
